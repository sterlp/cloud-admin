...
import { Pageable, Sort } from '@sterlp/ng-spring-boot-api';
import { SpringResoureceService } from './spring-resource.service';
...
export abstract class SpringDataSource<ListType, ResourceType> implements DataSource<ResourceType> {
    ...
    constructor(protected service: SpringResoureceService<ListType, ResourceType>, protected errorHandler?: DataSourceErrorHandler) {}
